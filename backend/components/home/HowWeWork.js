  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-blue-50/20 to-slate-50 py-24" data-testid="how-we-work">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <Reveal>
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-[#0284C7] font-semibold">How We Work</p>
          ...
          {PROCESS.map((p) => {
            ...
            return (
              <motion.div key={p.step} variants={itemVariants} className="relative">
                <TiltCard className="relative h-full rounded-3xl border border-white/80 bg-white/75 p-7 backdrop-blur-xl shadow-md transition-all duration-300 hover:border-[#0284C7]/40 hover:bg-white/90 hover:shadow-xl hover:shadow-[#0284C7]/10">
