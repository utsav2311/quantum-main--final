          ...
          {WHY.map((w) => {
            ...
            return (
              <motion.div key={w.title} variants={itemVariants}>
                <TiltCard className="group h-full rounded-3xl border border-white/80 bg-white/70 p-7 backdrop-blur-xl shadow-md transition-all duration-300 hover:border-[#FF6B4A]/50 hover:bg-white/90 hover:shadow-xl hover:shadow-[#FF6B4A]/10">
